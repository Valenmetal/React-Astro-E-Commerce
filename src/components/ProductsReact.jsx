...
export default function Products() {
    ...
    /* useEffect to make "show more" btn dissapear while there is no more products to show */
    let filtered = [];
    useEffect(() => {
    ...
    /* useEffect to make "show more" btn dissapear after 30s */
    useEffect(() => {
    ...
    return (<>
        <div className='product-container'>
            <h2 className="h2_products" id="products">Productos</h2>
